...
// const Driver = require('../dataModels/user/driverModel');
// const Vehicle = require('../dataModels/user/vehicleModel');
// const Point = require('../dataModels/route/pointModel');
// const Trip = require('../dataModels/journey/tripModel');
// const TripBooking = require('../dataModels/journey/tripBooking');
...
// Booking.belongsTo(Point, {foreignKey: 'sourcePointId', as: 'sourcePoint'});
// Booking.belongsTo(Point, {foreignKey: 'destinationPointId', as: 'destinationPoint'});
